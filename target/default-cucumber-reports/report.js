...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_attaches_a_link_by_clicking_on_the_link_icon()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_creates_a_quote_by_clicking_on_the_Coma_icon()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_adds_mention_by_clicking_on_the_Add_mention_icon_and_selects_contacts_from_the_lists_provided_in_dropdown()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_clicks_on_Visual_Editor_and_sees_the_editor_text_bar_displays_on_top_of_the_message_box()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_clicks_on_the_Topic_icon_to_see_the_annoucement_Topic_text_box_displays_on_top_of_the_message_box()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.bitrix.step_definitions.AnouncementStepDefinitions.user_adds_tags_by_selecting_existing_tags_or_creating_new_tags_by_clicking_on_the_icon()"
});
formatter.result({
  "status": "passed"
});
